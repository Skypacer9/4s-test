...
* Categorizing use cases of decentralized justice - focusing on functionality - decentralized justice systems could be categorized in optimistic mechanisms (a curation type case where a claim is considered true after a period without being challenged), price discovery, assets custody, sybil resistance
