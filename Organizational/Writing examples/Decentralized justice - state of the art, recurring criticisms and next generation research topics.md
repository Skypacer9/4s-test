...
-> showing how the old framework and the context in which it was derived (the multi million dollar disputes involving conglomerates and governments for which the framework of the New York Convention was established in 1958)
	...
	Legal harmonization - the process of making laws, regulations, legal standards more consistent across different jurisdictions - this means aligning core principles, procedures to reduce contradictions and frictions when legal systems interact -> harmonization can happen top down (binding treaties/directives) or bottom up (soft law, model laws, or market driven convergence) proccesses
